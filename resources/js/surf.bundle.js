      ...
      13695: (e, t, s) => {
        ...
        const m = {
          ...
          w = {
            ...
            settingsHamburgerMenu_container: {
              display: "flex",
              flexDirection: "row",
              alignItems: "center",
            },
            ...
            modsHamburgerMenu_settingsButton: {
              height: "20px",
              width: "20px",
              color: "currentColor",
              fill: "currentColor",
            },
            modsHamburgerMenu_modInfo: {
              display: "flex",
              flexDirection: "column",
              alignItems: "flex-start",
              minWidth: 0,
            },
            modsHamburgerMenu_modRowLeft: {
              display: "flex",
              flexDirection: "row",
              alignItems: "flex-start",
              gap: "8px",
            ...
            modsHamburgerMenu_modNameLink: {
              color: "inherit",
              textDecoration: "underline",
            },
            modsHamburgerMenu_modDescription: {
              fontSize: "12px",
              lineHeight: "1.2",
              marginTop: "2px",
              opacity: 0.85,
            },
            modsHamburgerMenu_modSettingsButton: {
              backgroundColor: "transparent",
              height: "20px",
              width: "20px",
              padding: "0px",
            ...
            modsHamburgerMenu_modSettingsIcon: {
              height: "16px",
              width: "16px",
              color: "currentColor",
              fill: "currentColor",
        ...
        // Expose internal classes for mods
        const SURF_INTERNAL_CLASSES = {
          Y,
          te,
          he,
          de,
        ...
        if ("undefined" != typeof window) {
          window.SurfModAPI = window.SurfModAPI || {};

          // Run a callback with all internal classes accessible
          // callback(classes)
          window.SurfModAPI.runWithClasses = function (callback) {
            if ("function" != typeof callback) return;
            try {
              return callback(SURF_INTERNAL_CLASSES);
            } catch (err) {
              console.error("SurfModAPI.runWithClasses error", err);
            }
          };

          // Run a callback in the context of a specific class
          // callback.call(targetClass, targetClass, classes)
          window.SurfModAPI.runInClassScope = function (className, callback) {
            if ("function" != typeof callback) return;
            const target = SURF_INTERNAL_CLASSES[className];
            if (!target) return;
            try {
              return callback.call(target, target, SURF_INTERNAL_CLASSES);
            } catch (err) {
              console.error("SurfModAPI.runInClassScope error", err);
            }
          };
        }
        ...
        class ht extends O.Z {
          constructor(e) {
            super(e),
              ...
              at(this, "modsButtonRef", a.createRef()),
              ...
              at(this, "toggleModsMenu", () => {
                this.state.modsMenuOpen || this.loadModsListIfNeeded(),
                  this.setState({
                    modsMenuOpen: !this.state.modsMenuOpen,
                  });
              }),
              at(this, "dismissMenu", () => {
                this.setState({
              ...
              at(this, "closeModal", () => {
                ...
                this.setState({
                  modSettingsModalModId: null,
                  modSettingsModalMeta: null,
              ...
              at(this, "getModSettingsDefaults", (e) => {
                ...
                return (
                  (Array.isArray(e) ? e : []).forEach((e) => {
                    e && e.name && (t[String(e.name)] = e.default);
                  }),
                  t
                );
              }),
              at(this, "loadModSettingsFromStorage", (e) => {
                if (!("localStorage" in window)) return {};
                try {
                  const t = window.localStorage.getItem(this.getModSettingsStorageKey(e));
                  if (!t) return {};
                  const s = JSON.parse(t);
                  return s && "object" == typeof s && !Array.isArray(s) ? s : {};
                } catch (e) {
                  return {};
                }
              }),
              at(this, "normalizeModSettingValue", (e, t) => {
                const s = (e && e.type ? String(e.type) : "string").toLowerCase();
                if ("bool" === s || "boolean" === s) return Boolean(t);
                if ("number" === s) {
                  const e = "string" == typeof t && "" === t.trim() ? NaN : Number(t);
                  return Number.isFinite(e) ? e : void 0;
                }
                return "undefined" == typeof t || null === t ? "" : String(t);
              }),
              at(this, "openModSettingsModal", (e) => {
                const t = (this.state.availableMods || []).find((t) => t && t.id === e);
                if (!t) return;
                const s = Array.isArray(t.settings) ? t.settings : [];
                const i = this.getModSettingsDefaults(s);
                const o = this.loadModSettingsFromStorage(e);
                const n = { ...i };
                s.forEach((t) => {
                  if (!t || !t.name) return;
                  const s = String(t.name);
                  if (!(s in i) || !(s in o)) return;
              ...
              at(this, "onModSettingChange", (e, t) => {
                const s = this.state.modSettingsModalValues;
                if (!s) return;
                this.setState({
                  modSettingsModalValues: {
                    ...s,
                    [String(e)]: t,
                  },
                });
              }),
              at(this, "saveModSettingsModal", () => {
                if (!("localStorage" in window)) return;
                const e = this.state.modSettingsModalModId;
                const t = this.state.modSettingsModalMeta || [];
                const s = this.state.modSettingsModalValues || {};
                if (!e) return;
                const i = {};
                t.forEach((e) => {
                  ...
                  const a = this.normalizeModSettingValue(e, s[t]);
                  if ("undefined" != typeof a) i[t] = a;
                  else i[t] = e.default;
                });
                try {
              ...
              at(this, "resetModSettingsModal", () => {
                ...
                const t = this.state.modSettingsModalMeta || [];
                if (!e) return;
                const s = this.getModSettingsDefaults(t);
                try {
                  window.localStorage.setItem(this.getModSettingsStorageKey(e), JSON.stringify(s));
                } catch (e) {}
                this.setState({ modSettingsModalValues: s });
              }),
              at(this, "renderModSettingsModalBody", () => {
                const e = this.state.modSettingsModalModId;
                const t = this.state.modSettingsModalMeta || [];
                const s = this.state.modSettingsModalValues || {};
                if (!e)
                ...
                return a.createElement(
                  ...
                  t.length
                    ? t.map((t) => {
                        ...
                        const i = String(t.name);
                        const o = (t.type ? String(t.type) : "string").toLowerCase();
                        const n = `mod-setting-${String(e)}-${i}`;
                        return a.createElement(
                          "div",
                          { key: i, style: { marginBottom: "12px" } },
                          a.createElement(
                            E.__,
                            { htmlFor: n, style: { fontWeight: "bold" } },
                            i
                          ),
                          "bool" === o || "boolean" === o
                            ? a.createElement("input", {
                                ...
                                checked: Boolean(s[i]),
                                onChange: (e) =>
                                  this.onModSettingChange(i, e.target.checked),
                              })
                            : a.createElement("input", {
                                id: n,
                                type: "number" === o ? "number" : "text",
                                value:
                                  "undefined" == typeof s[i] || null === s[i]
                                    ? ""
                                    : String(s[i]),
                                onChange: (e) =>
                                  this.onModSettingChange(
                                    i,
                                    "number" === o ? e.target.value : e.target.value
                                  ),
                              })
                        );
                      })
              ...
              at(this, "getGameCreditsModalBody", () =>
                ...
                a.createElement(
                  ...
                  a.createElement(
                    ...
                    Z.pz.getString("gameCreditsVersionSection")
                  ),
                  a.createElement(
                    x.nv,
                    null,
                    "moddableSurf version alpha" // TODO: Localize
                  ),
                  a.createElement(
                    x.nv,
                    null,
                    "Base version: Edge 98" // TODO: Localize
                  ),
                  a.createElement(
                    S.X6,
                    {
                    ...
                    Z.pz.getString("gameCreditsSection")
                  ),
                  a.createElement(
                    x.nv,
                    null,
                  ...
                  a.createElement(
                    ...
                    Z.pz.getString("specialThanksMod")
                  ),
                  a.createElement(
                    x.nv,
                    null,
                    "LiuWoodsCode, jackbuehner"
                  ),
                  a.createElement(
                    S.X6,
                    {
                    ...
                    Z.pz.getString("gameCreditsLegalSection")
                  ),
                  a.createElement(
                    x.nv,
                    null,
                    "This project is not an official Microsoft product, nor is it offically affiliated with Microsoft in any way, shape, or form." // TODO: localize
                  ),
                  a.createElement(
                    x.nv,
                    null,
              ...
              at(this, "onToggleModSelected", (e) => {
                const t = this.state.selectedMods || [],
                  s = t.indexOf(e),
                  i = s === -1 ? [...t, e] : t.filter((t) => t !== e);
                this.setState({
                  selectedMods: i,
                }),
                  bt(i);
              }),
              at(this, "loadModsListIfNeeded", async () => {
                if (this.state.availableModsLoaded) return;
                const e = await yt();
                this.setState({
                  availableMods: e,
                  selectedMods:
                    this.state.selectedMods &&
                      this.state.selectedMods.length
                      ? this.state.selectedMods
                      : wt(),
                  availableModsLoaded: !0,
                });
              }),
              (this.state = {
                menuOpen: !1,
                ...
                a.createElement(
                  ...
                  a.createElement(
                    ...
                    a.createElement(
                      k.XC,
                      {
                        ref: this.modsButtonRef,
                        onClick: this.onModsButtonClick,
                        className: (0, R.A)(
                          this.props.managedClasses.modsHamburgerMenu
                        ),
                        title: "Mods",
                      },
                      a.createElement(
          ...
          renderModsMenu() {
            const e = this.state.availableMods || [],
              t = this.state.selectedMods || [];
            return a.createElement(
              T.zg,
              {
              className:
              ...
              ? e.map((e) =>
                a.createElement(
                  ...
                  a.createElement(
                    ...
                    {
                      className:
                        this.props.managedClasses.modsHamburgerMenu_modRowLeft,
                    },
                    a.createElement(
                      E.__,
                      {
                      ...
                      a.createElement(
                        ...
                        {
                          className:
                            this.props.managedClasses.modsHamburgerMenu_modInfo,
                        },
                        e.link && /^https?:\/\//.test(String(e.link))
                          ? a.createElement(
                              "a",
                              {
                                href: String(e.link),
                    ...
                    e.settings && Array.isArray(e.settings) && e.settings.length
                      ? a.createElement(
                          k.XC,
                          {
                            className:
                            ...
                            onClick: (t) => {
                              t.stopPropagation();
                              this.openModSettingsModal(e.id);
                            },
                          },
                          a.createElement(
                            "svg",
                            ...
                            a.createElement("path", {
                              d: "M12.0124 2.25C12.7464 2.25846 13.4775 2.34326 14.1939 2.50304C14.5067 2.57279 14.7406 2.83351 14.7761 3.15196L14.9463 4.67881C15.0233 5.37986 15.6152 5.91084 16.3209 5.91158C16.5105 5.91188 16.6982 5.87238 16.8734 5.79483L18.2741 5.17956C18.5654 5.05159 18.9057 5.12136 19.1232 5.35362C20.1354 6.43464 20.8892 7.73115 21.3279 9.14558C21.4225 9.45058 21.3137 9.78203 21.0566 9.9715L19.8151 10.8866C19.461 11.1468 19.2518 11.56 19.2518 11.9995C19.2518 12.4389 19.461 12.8521 19.8159 13.1129L21.0585 14.0283C21.3156 14.2177 21.4246 14.5492 21.3299 14.8543C20.8914 16.2685 20.138 17.5649 19.1264 18.6461C18.9091 18.8783 18.569 18.9483 18.2777 18.8206L16.8714 18.2045C16.4691 18.0284 16.007 18.0542 15.6268 18.274C15.2466 18.4937 14.9935 18.8812 14.9452 19.3177L14.7761 20.8444C14.7413 21.1592 14.5124 21.4182 14.2043 21.4915C12.7558 21.8361 11.2467 21.8361 9.79828 21.4915C9.49015 21.4182 9.26129 21.1592 9.22643 20.8444L9.0576 19.32C9.00802 18.8843 8.75459 18.498 8.37467 18.279C7.99475 18.06 7.53345 18.0343 7.13244 18.2094L5.72582 18.8256C5.43446 18.9533 5.09428 18.8833 4.87703 18.6509C3.86487 17.5685 3.11144 16.2705 2.67344 14.8548C2.57911 14.5499 2.68811 14.2186 2.94509 14.0293L4.18842 13.1133C4.54256 12.8531 4.75172 12.4399 4.75172 12.0005C4.75172 11.561 4.54256 11.1478 4.18796 10.8873L2.94541 9.97285C2.68804 9.78345 2.57894 9.45178 2.67361 9.14658C3.11236 7.73215 3.86619 6.43564 4.87837 5.35462C5.09584 5.12236 5.43618 5.05259 5.72749 5.18056L7.12786 5.79572C7.53081 5.97256 7.99404 5.94585 8.37601 5.72269C8.75633 5.50209 9.00953 5.11422 9.05841 4.67764L9.22849 3.15196C9.26401 2.83335 9.49811 2.57254 9.81105 2.50294C10.5283 2.34342 11.2602 2.25865 12.0124 2.25ZM11.9999 8.99995C10.3431 8.99995 8.99994 10.3431 8.99994 12C8.99994 13.6568 10.3431 15 11.9999 15C13.6568 15 14.99994 13.6568 14.99994 12C14.99994 10.3431 13.6568 8.99995 11.9999 8.99995Z",
                            })
                          )
                        )
                      : null
            ...
            return a.createElement(
              ...
              a.createElement(
                ...
                a.createElement(L.$m, {
                  id: "surfNew",
                  value: "surfNew",
                  displayString: Z.pz.getString("surfThemeNew"),
                })
              )
            );
          }
        ...
        function wt() {
          if (!("localStorage" in window)) return [];
          try {
            const e = window.localStorage.getItem(pt);
            if (!e) return [];
        ...
        function bt(e) {
          if (!("localStorage" in window)) return;
          try {
            const t = Array.from(new Set(e.map(String)));
        ...
        async function yt() {
          try {
            const e = await fetch("mods/mods.json");
            if (!e.ok) return [];
            ...
            return t
              .map((e) => {
                if (!e) return null;
                const t = e.id || e.name || e.path || e.file,
                  s = e.path || e.file,
                  i = e.name || t;
                if (!t || !s) return null;

                const a =
                  "string" == typeof e.description && e.description.trim()
                    ? e.description.trim()
                    : null;
                const o =
                  "string" == typeof e.link && /^https?:\/\//.test(e.link.trim())
                    ? e.link.trim()
                    : null;

                const n = Array.isArray(e.settings)
                  ? e.settings
                      .map((e) => {
                        if (!e || !e.name) return null;
                        const t = String(e.name);
                        const s = (e.type ? String(e.type) : "string").toLowerCase();
                        const i = "bool" === s || "boolean" === s ? "bool" : "number" === s ? "number" : "string";
                        const a = e.default;
                        return { name: t, type: i, default: a };
                      })
                      .filter(Boolean)
                  : [];
                return {
          ...
          return new Promise((t, s) => {
            try {
              ...
              (i.src = e),
                (i.async = !0),
                (i.onload = () => t()),
                (i.onerror = () => s(new Error("Failed to load mod script: " + e))),
          ...
          for (const i of e) {
            ...
            if (e) {
              ...
              (t.startsWith("http://") ||
                ...
                t.startsWith("/") ||
                t.startsWith("./") ||
                t.startsWith("../")) || (t = "mods/" + t);
              try {
                window.__surfRegisterModScript &&
                  window.__surfRegisterModScript({ id: e.id, name: e.name, src: t });
                await mt(t);
              } catch (e) {
                console.error(e);
              }
